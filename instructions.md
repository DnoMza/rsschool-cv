...
Если ссылка в футере ведёт на курс stage0 или на English курс, это не ошибка.
...
<!-- -- перечень выполненных учебных проектов со ссылками на исходный код или страницу приложения +5 ( НЕТУ ) -->
